    ...
    public class ResponseManager
    {
            ...
            responses = new Dictionary<string, List<string>>
            {
...

                {
                    ...
                    new List<string>
                    {
                        ...
                        "2FA helps protect your accounts even if your password is stolen.",
                        "Always enable 2FA on important accounts whenever possible."
                    }
                }
            };
        }
        ...
        public string GetMoreInfo(string topic)
        {
            switch (topic)
            {
                ...
                case "2fa":
                    return "Two-factor authentication requires a second verification step such as a code sent to your phone.";
